        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                <div class="card h-100">
                    <img src="{{ $item->cover !=null ? asset('storage/cover/'.$item->cover) : asset('images/d562ecd1a8bb93998db28f165623765b-buku.jpg')}}"  height="200" class="card-img-top" draggable="false">
